...
SlideNestedPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-slide-nested',template:/*ion-inline-start:"/Users/mirzailhami/Dropbox/ionium2/src/pages/slide/slide-nested/slide-nested.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Nested Slides</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-slides #slider pager>\n    <ion-slide *ngFor="let slide of slides"\n               [ngStyle]="{\'background\' : \'url(\' + slide.imageUrl + \')\'}">\n      <h2>{{slide.title}}</h2>\n    </ion-slide>\n    <ion-slides pager direction="vertical">\n      <ion-slide *ngFor="let slide of slides"\n                  [ngStyle]="{\'background\' : \'url(\' + slide.imageUrl + \')\'}">\n        <h2>{{slide.title}}</h2>\n      </ion-slide>\n    </ion-slides>\n  </ion-slides>\n</ion-content>\n\n'/*ion-inline-end:"/Users/mirzailhami/Dropbox/ionium2/src/pages/slide/slide-nested/slide-nested.html"*/
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__slide_nested__ = __webpack_require__(1137);
...
var SlideNestedPageModule = (function () {
...
SlideNestedPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__slide_nested__["a" /* SlideNestedPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_0__slide_nested__["a" /* SlideNestedPage */]
        ]
