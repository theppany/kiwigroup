...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__toast__ = __webpack_require__(995);
...
ToastPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__toast__["a" /* ToastPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__toast__["a" /* ToastPage */]
        ]
...
ToastPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-toast',template:/*ion-inline-start:"/Users/mirzailhami/Dropbox/ionium2/src/pages/components/toast/toast.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Toast</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <button ion-button block (click)="showToast(\'top\')">Show Toast Top Position</button>\n  <button ion-button block (click)="showToast(\'middle\')">Show Toast Middle Position</button>\n  <button ion-button block (click)="showToast(\'bottom\')">Show Toast Bottom Position</button>\n  <button ion-button block (click)="showLongToast()">Show Long Toast</button>\n  <button ion-button block (click)="showToastWithCloseButton()">Show Toast W/ Close Button</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/mirzailhami/Dropbox/ionium2/src/pages/components/toast/toast.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavParams */]])
], ToastPage);
