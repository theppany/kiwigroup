...
FirebaseLoginPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-firebase-login',template:/*ion-inline-start:"/Users/mirzailhami/Dropbox/ionium2/src/pages/firebase/firebase-auth/firebase-login/firebase-login.html"*/'<ion-content padding class="transparent-header" [ngStyle]="{\'background-image\': \'url(\' + backgroundImage +\')\'}">    \n  <ion-header no-border>\n    <ion-navbar transparent>\n    </ion-navbar>\n  </ion-header>\n  <div class="login-container">\n    <img class="logo" src="assets/img/logo/logo.png" />\n    <h2>Login</h2>\n    <ion-row>\n      <form [formGroup]="loginForm" (ngSubmit)="doLogin()">\n        <ion-item padding-right>\n          <ion-label>Email</ion-label>\n          <ion-input type="text" formControlName="email" ></ion-input>\n        </ion-item>\n        <ion-item padding-right>\n          <ion-label>Password</ion-label>\n          <ion-input type="password" formControlName="password" ></ion-input>\n        </ion-item>\n        <div>\n          <button ion-button class="submit-btn" full type="submit" >Login</button>\n        </div>\n      </form>\n    </ion-row>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/mirzailhami/Dropbox/ionium2/src/pages/firebase/firebase-auth/firebase-login/firebase-login.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__firebase_login__ = __webpack_require__(1005);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
FirebaseLoginPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__firebase_login__["a" /* FirebaseLoginPage */]),
        ],
    })
